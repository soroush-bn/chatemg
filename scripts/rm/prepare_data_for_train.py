from scripts.rm.convert_to_p7_format import get_IMU_df, get_emg_df,convert_raw_values
import os
import pandas as pd
import numpy as np
import yaml
...
if __name__ == "__main__":
    # 1. read all raw subject data, convert them, and merge all of them at the end
